...
function LernendenAddForm() {
    ...
    return (
        ...
        <Form className="mt-4" onSubmit={handleSubmit}>
            <Form.Group className="mb-3" controlId="formLernendeNr">
                <Form.Label>Lernende Nr.</Form.Label>
                <Form.Control required name="id_lernende" type="number" placeholder="Lernende Nr." onChange={handleChange}/>
            </Form.Group>
